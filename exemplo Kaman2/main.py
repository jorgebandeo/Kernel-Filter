...
from kflms_filter import apply_kflms_filter
...
# Aplicar o filtro KFLMS e mostrar os resultados
predictions, nmse_values, psnr_values = apply_kflms_filter(signal, signal_with_noise)
...
plt.tight_layout()
plt.savefig('./Sinais Artificiais/Simulação.png')
plt.show()
